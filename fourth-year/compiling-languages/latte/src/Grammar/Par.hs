...
{-# INLINE happyOut11 #-}
newtype HappyWrap12 = HappyWrap12 ((Grammar.Abs.BNFC'Position, Grammar.Abs.Block))
happyIn12 :: ((Grammar.Abs.BNFC'Position, Grammar.Abs.Block)) -> (HappyAbsSyn )
happyIn12 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap12 x)
{-# INLINE happyIn12 #-}
happyOut12 :: (HappyAbsSyn ) -> HappyWrap12
happyOut12 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut12 #-}
newtype HappyWrap13 = HappyWrap13 ((Grammar.Abs.BNFC'Position, [Grammar.Abs.Stmt]))
happyIn13 :: ((Grammar.Abs.BNFC'Position, [Grammar.Abs.Stmt])) -> (HappyAbsSyn )
...
{-# INLINE happyOut15 #-}
newtype HappyWrap16 = HappyWrap16 ((Grammar.Abs.BNFC'Position, [Grammar.Abs.Item]))
happyIn16 :: ((Grammar.Abs.BNFC'Position, [Grammar.Abs.Item])) -> (HappyAbsSyn )
...
{-# INLINE happyOut26 #-}
newtype HappyWrap27 = HappyWrap27 ((Grammar.Abs.BNFC'Position, Grammar.Abs.AddOp))
happyIn27 :: ((Grammar.Abs.BNFC'Position, Grammar.Abs.AddOp)) -> (HappyAbsSyn )
happyIn27 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap27 x)
{-# INLINE happyIn27 #-}
happyOut27 :: (HappyAbsSyn ) -> HappyWrap27
happyOut27 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut27 #-}
newtype HappyWrap28 = HappyWrap28 ((Grammar.Abs.BNFC'Position, Grammar.Abs.MulOp))
happyIn28 :: ((Grammar.Abs.BNFC'Position, Grammar.Abs.MulOp)) -> (HappyAbsSyn )
happyIn28 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap28 x)
{-# INLINE happyIn28 #-}
happyOut28 :: (HappyAbsSyn ) -> HappyWrap28
happyOut28 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut28 #-}
newtype HappyWrap29 = HappyWrap29 ((Grammar.Abs.BNFC'Position, Grammar.Abs.RelOp))
happyIn29 :: ((Grammar.Abs.BNFC'Position, Grammar.Abs.RelOp)) -> (HappyAbsSyn )
