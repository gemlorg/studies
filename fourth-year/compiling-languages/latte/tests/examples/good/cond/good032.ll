...
@_v3 = private   constant [4 x i8] c"bbb\00"


@_v8 = private   constant [9 x i8] c"it works\00"


@_v11 = private   constant [8 x i8] c"failure\00"
...
_B1:
  %_v9 = bitcast [9 x i8]* @_v8 to i8* 
   call ccc  void  @printString(i8*  %_v9)  
  br label %_B3 
_B2:
  %_v12 = bitcast [8 x i8]* @_v11 to i8* 
