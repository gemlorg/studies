...
@_g0 =    constant [4 x i8] c"aaa\00"


@_g1 =    constant [4 x i8] c"bbb\00"


@_g2 =    constant [8 x i8] c"failure\00"


@_g3 =    constant [9 x i8] c"it works\00"
...
_B1:
  %_v4 = bitcast [8 x i8]* @_g2 to i8* 
   call ccc  void  @printString(i8*  %_v4)  
  br label %_B3 
_B2:
  %_v6 = bitcast [9 x i8]* @_g3 to i8* 
