...
entry:
  ...
  store   %A* %_v0, %A** %_v6  
  %_v7 = alloca %A* 
  store   %A* zeroinitializer, %A** %_v7  
  br label %_B2 
_B1:
  %_v9 = load   %A*, %A** %_v6  
  store   %A* %_v9, %A** %_v7  
  %_v10 = load   %A*, %A** %_v6  
  %_v11 = getelementptr  %A, %A* %_v10, i32 0, i32 1 
  store   i32 %_v8, i32* %_v11  
  %_v12 = load   %A*, %A** %_v7  
  ...
  br label %_B2 
_B2:
  %_v8 = phi i32 [0, %entry], [%_v16, %_B1] 
  %_v17 = icmp slt i32 %_v8, 10 
  br i1 %_v17, label %_B1, label %_B3 
_B3:
  %_v18 = load   %A*, %A** %_v7  
  %_v19 = getelementptr  %A, %A* %_v18, i32 0, i32 1 
