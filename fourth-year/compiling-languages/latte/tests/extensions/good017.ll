...
entry:
  ...
  %_v22 = load   %A*, %A** %_v5  
  %_v23 = getelementptr  %A, %A* %_v22, i32 0, i32 0 
  %_v24 = load   %_A_vtype*, %_A_vtype** %_v23  
  %_v25 = getelementptr  %_A_vtype, %_A_vtype* %_v24, i32 0, i32 0 
  %_v26 = load   void (%A*)*, void (%A*)** %_v25  
   call ccc  void  %_v26(%A*  %_v22)  
  ret i32 0 
}