...
@_g0 =    constant [15 x i8] c"hello good015 \00"
...
entry:
  ...
  %_v15 = bitcast [1 x i8]* @_g1 to i8* 
  %_v12 =  call ccc  %A*  @_A_malloc()  
  %_v13 = getelementptr  %A, %A* %_v12, i32 0, i32 0 
  store   %_A_vtype* @_A_vdata, %_A_vtype** %_v13  
  %_v14 = getelementptr  %A, %A* %_v12, i32 0, i32 1 
  store   i32 0, i32* %_v14  
  %_v16 = getelementptr  %A, %A* %_v12, i32 0, i32 2 
  store   i8* %_v15, i8** %_v16  
  %_v17 = getelementptr  %A, %A* %_v12, i32 0, i32 0 
  %_v18 = load   %_A_vtype*, %_A_vtype** %_v17  
  %_v19 = getelementptr  %_A_vtype, %_A_vtype* %_v18, i32 0, i32 0 
  %_v20 = load   void (%A*)*, void (%A*)** %_v19  
   call ccc  void  %_v20(%A*  %_v12)  
  ret i32 0 
}