...
_B1:
  ...
  br label %_B2 
_B2:
  %_v37 = phi i32 [0, %entry], [%_v44, %_B1] 
  %_v45 = getelementptr  %_arr, %_arr* %_v0, i32 0, i32 1 
  %_v46 = load   i32, i32* %_v45  
  %_v47 = icmp slt i32 %_v37, %_v46 
  br i1 %_v47, label %_B1, label %_B3 
_B3:
  ret i32 0 
}