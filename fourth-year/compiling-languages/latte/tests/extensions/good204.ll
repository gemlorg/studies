...
_B7:
  %_v78 = load   %A*, %A** %_v11  
  %_v79 = getelementptr  %A, %A* %_v78, i32 0, i32 5 
  %_v80 = load   i32, i32* %_v79  
  %_v81 =  call ccc  %_arr*  @__arr_malloc()  
  %_v82 = mul   i32 4, %_v80 
  %_v83 =  call ccc  i8*  @_malloc(i32  %_v82)  
  %_v84 = getelementptr  %_arr, %_arr* %_v81, i32 0, i32 0 
  store   i8* %_v83, i8** %_v84  
  %_v85 = getelementptr  %_arr, %_arr* %_v81, i32 0, i32 1 
  store   i32 %_v80, i32* %_v85  
  %_v86 = load   %A*, %A** %_v11  
  %_v87 = getelementptr  %A, %A* %_v86, i32 0, i32 7 
  store   %_arr* %_v81, %_arr** %_v87  
  %_v88 = load   %A*, %A** %_v11  
  %_v89 = getelementptr  %A, %A* %_v88, i32 0, i32 5 
  %_v90 = load   i32, i32* %_v89  
  %_v91 = sub   i32 %_v90, 1 
  %_v92 = load   %A*, %A** %_v11  
  %_v93 = getelementptr  %A, %A* %_v92, i32 0, i32 5 
  store   i32 %_v91, i32* %_v93  
  br label %_B8 
_B8:
  %_v94 = load   %A*, %A** %_v11  
  %_v95 = getelementptr  %A, %A* %_v94, i32 0, i32 5 
  %_v96 = load   i32, i32* %_v95  
  %_v97 = icmp sgt i32 %_v96, 0 
  br i1 %_v97, label %_B7, label %_B9 
_B9:
  ret i32 0 
}