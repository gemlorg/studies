...
_B1:
  %_v7 = add   i32 %_v6, 2 
  %_v8 =  call ccc  %_arr*  @__arr_malloc()  
  %_v9 = mul   i32 8, 20 
  %_v10 =  call ccc  i8*  @_malloc(i32  %_v9)  
  %_v11 = getelementptr  %_arr, %_arr* %_v8, i32 0, i32 0 
  store   i8* %_v10, i8** %_v11  
  %_v12 = getelementptr  %_arr, %_arr* %_v8, i32 0, i32 1 
  store   i32 20, i32* %_v12  
  br label %_B2 
_B2:
  %_v6 = phi i32 [1, %entry], [%_v7, %_B1] 
  %_v13 = icmp slt i32 %_v6, 20 
