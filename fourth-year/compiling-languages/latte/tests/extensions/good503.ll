...
entry:
  ...
  %_v3 = load   %A*, %A** %_v0  
  %_v2 = getelementptr  %A, %A* %_v3, i32 0, i32 1 
  %_v4 = load   i32, i32* %_v2  
...
entry:
  ...
  %_v2 = load   %_A_vtype*, %_A_vtype** %_v1  
  %_v3 = getelementptr  %_A_vtype, %_A_vtype* %_v2, i32 0, i32 0 
  %_v4 = load   void (%A*)*, void (%A*)** %_v3  
   call ccc  void  %_v4(%A*  %_v0)  
  ret i32 0 
}
