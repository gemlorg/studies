...
entry:
  ...
  %_v29 = alloca %A* 
  store   %A* zeroinitializer, %A** %_v29  
  store   %A* %_v23, %A** %_v29  
  %_v34 = bitcast [1 x i8]* @_g0 to i8* 
  %_v30 =  call ccc  %A*  @_A_malloc()  
  %_v31 = getelementptr  %A, %A* %_v30, i32 0, i32 0 
  store   %_A_vtype* @_A_vdata, %_A_vtype** %_v31  
  %_v32 = getelementptr  %A, %A* %_v30, i32 0, i32 1 
  store   i32 0, i32* %_v32  
  %_v33 = getelementptr  %A, %A* %_v30, i32 0, i32 2 
  store   i32 0, i32* %_v33  
  %_v35 = getelementptr  %A, %A* %_v30, i32 0, i32 3 
  store   i8* %_v34, i8** %_v35  
  %_v36 = load   %A*, %A** %_v29  
  %_v37 = getelementptr  %A, %A* %_v36, i32 0, i32 1 
