...
pub mod atomic_register_public {
    ...
    pub async fn build_atomic_register(
        ...
        Box::new(
            crate::atomic_register::atomic_register_impl::AtomicRegisterImpl::new(
                self_ident,
                sector_idx,
                register_client,
                sectors_manager,
...
pub mod sectors_manager_public {
    ...
    pub async fn build_sectors_manager(path: PathBuf) -> Arc<dyn SectorsManager> {
        Arc::new(crate::sectors_manager::sectors_manager_impl::SectorsManagerImpl::new(path).await)
    }
}
...
pub mod transfer_public {
    ...
    pub async fn deserialize_register_command(
        ...
        crate::transfer::transfer_impl::deserialize_register_command(
            data,
            hmac_system_key,
            hmac_client_key,
        )
    ...
    pub async fn serialize_register_command(
        ...
        crate::transfer::transfer_impl::serialize_register_command(cmd, writer, hmac_key).await
    }
}
