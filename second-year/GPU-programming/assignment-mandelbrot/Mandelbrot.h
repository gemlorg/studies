...
int computeMandelbrotSygnatura(real X0, real Y0, real X1, real Y1, int POZ, int PION, int ITER, int *Mandel, unsigned int *Sygnatura);
int computeMandelbrot2D(real X0, real Y0, real X1, real Y1, int POZ, int PION, int ITER, int *Mandel);
int computeMandelbrot2DSygnatura(real X0, real Y0, real X1, real Y1, int POZ, int PION, int ITER, int *Mandel, unsigned int *Sygnatura);
