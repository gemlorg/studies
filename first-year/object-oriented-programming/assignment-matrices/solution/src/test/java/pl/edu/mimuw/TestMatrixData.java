...
import pl.edu.mimuw.matrix.types.IdentityMatrix;
...
public class TestMatrixData {
  ...
  public static final IDoubleMatrix CONSTANT_3X2 = constant(matrix(3, 2), 1);

  public static final IDoubleMatrix CONSTANT_2X3 = constant(matrix(2, 3), 1);

  public static final IDoubleMatrix CONSTANT_3X3 = constant(matrix(3, 3), 1);

  public static final IDoubleMatrix FULL_3X3 = full(new double[][] {
                  new double[]{1, 2, 3},
                  new double[]{4, 5, 6},
                  new double[]{7, 8, 9}
          });
