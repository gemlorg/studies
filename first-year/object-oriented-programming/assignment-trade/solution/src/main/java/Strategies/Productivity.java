...
public class Productivity {
    ...
    public int diamonds(Players.Strategies.Career career, ProductionReserve reserve){
    ...
    public int food(Players.Strategies.Career career, ProductionReserve reserve){
        double efficiencyRate = 100;
        for (int effect : effects){
            efficiencyRate += effect;
        }
    ...
    public int clothes(Players.Strategies.Career career, ProductionReserve reserve){
        double efficiencyRate = 100;
        for (int effect : effects){
            efficiencyRate += effect;
        }
    ...
    public int tools(Players.Strategies.Career career, ProductionReserve reserve){
        double efficiencyRate = 100;
        for (int effect : effects){
            efficiencyRate += effect;
        }
    ...
    public int programs(Players.Strategies.Career career, ProductionReserve reserve){
        double efficiencyRate = 100;
        for (int effect : effects){
            efficiencyRate += effect;
        }
