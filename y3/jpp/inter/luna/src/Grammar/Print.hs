...
instance Print (Grammar.Abs.Arg' a) where
  prt i = \case
    Grammar.Abs.AArg _ id_ type_ -> prPrec i 0 (concatD [prt 0 id_, doc (showString ":"), prt 0 type_])
    Grammar.Abs.AArgVar _ id_ type_ -> prPrec i 0 (concatD [doc (showString "var"), prt 0 id_, doc (showString ":"), prt 0 type_])
...
instance Print (Grammar.Abs.DeclKind' a) where
  prt i = \case
    Grammar.Abs.VDecl _ id_ type_ item -> prPrec i 0 (concatD [doc (showString "var"), prt 0 id_, doc (showString ":"), prt 0 type_, prt 0 item, doc (showString ";")])
    Grammar.Abs.FDecl _ id_ args type_ block -> prPrec i 0 (concatD [doc (showString "fn"), prt 0 id_, doc (showString "("), prt 0 args, doc (showString ")"), doc (showString "->"), prt 0 type_, prt 0 block])
